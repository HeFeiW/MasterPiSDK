...
class VisualPatrol():
    # global variables
    # color detection
    lab_data = None # color configuration
    ...
    # 设置检测颜色
    def setTrackColor(target_color):
        global __target_color#TODO这里global变量可以定义在另一个文件吗？

        print("set track color to:", target_color)
